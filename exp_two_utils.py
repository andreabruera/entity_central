...
def read_datasets():
    with open(os.path.join('exp_two_data', 'anew_montefinese.csv'), encoding='latin-1') as i:
    ...
    ### perceptual
    with open(os.path.join('exp_two_data', 'anew_perceptual.txt'), encoding='latin-1') as i:
